...
void __assert(const char *pfunction_name, const char *pfile_path, int line_num, const char *failedexpr)
{
  ...
  write_string(F(":"));
  log_internal(line_num, pfunction_name, true, F("assertion failed: %s"), failedexpr);
